...
<head>
    ...
    <title>404 - Not Found | <?php echo e(config('app.name', 'POS Cafe')); ?></title>
...
<body class="bg-gradient-to-br from-amber-50 via-white to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 min-h-screen antialiased">
    <div class="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p class="text-gray-500 dark:text-gray-400 text-lg mb-8 max-w-md">
            <?php echo e(__('The page you\'re looking for doesn\'t exist or has been moved.')); ?>
...
<?php /**PATH D:\Herd\cafe-pos-shop\resources\views\errors\404.blade.php ENDPATH**/ ?>