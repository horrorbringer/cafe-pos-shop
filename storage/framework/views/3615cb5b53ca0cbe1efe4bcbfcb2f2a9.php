...
<head>
    ...
    <title><?php echo e($menuSettings['title'] ?? config('app.name', 'POS Cafe')); ?></title>
...
<body class="bg-gray-50 min-h-screen antialiased" x-data="menuApp()" :class="{ 'bg-gray-900': darkMode, 'pb-20': cartCount > 0 }">
    <div class="max-w-lg mx-auto px-4 py-6">
            ...
            <div class="flex gap-1 overflow-x-auto pb-1 scrollbar-hide border-b" :class="darkMode ? 'border-gray-700' : 'border-gray-100'" style="-webkit-overflow-scrolling: touch;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button @click="activeCategory = '<?php echo e($category->slug); ?>'"
                        class="px-3 py-2.5 text-sm font-medium whitespace-nowrap shrink-0 border-b-2 -mb-px transition-all duration-200"
                        :class="activeCategory === '<?php echo e($category->slug); ?>' ? '' : 'border-transparent'"
                        :style="activeCategory === '<?php echo e($category->slug); ?>' ? { borderBottomColor: primaryColor, color: primaryColor } : (darkMode ? { color: '#9ca3af' } : { color: '#6b7280' })">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div x-show="activeCategory === 'all' || activeCategory === '<?php echo e($category->slug); ?>'"
                x-cloak
                ...
                <div class="flex items-center gap-2 mb-3 px-0.5">
                    ...
                    <h2 class="text-lg font-bold tracking-tight" :class="darkMode ? 'text-white' : 'text-gray-900'"><?php echo e($category->name); ?></h2>
                    <span class="text-[11px] px-2 py-0.5 rounded-full font-semibold" :class="darkMode ? 'bg-gray-700 text-gray-400' : 'bg-gray-100 text-gray-500'"><?php echo e($category->products->count()); ?></span>
                </div>
                ...
                <?php else: ?>
                    <div class="grid gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            ?>
                            <div x-show="matchesSearch(<?php echo e($product->id); ?>)"
                                x-cloak
                                x-transition:enter="transition ease-out duration-200"
                                x-transition:enter-start="opacity-0 scale-95"
                                x-transition:enter-end="opacity-100 scale-100"
                                @click="openModal(<?php echo e($product->id); ?>)"
                                ...
                                <div class="flex">
                                    ...
                                    <div class="w-28 sm:w-32 shrink-0 relative">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($productImage): ?>
                                            <img src="<?php echo e($productImage); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover" loading="lazy" srcset="<?php echo e($productImage); ?>?w=160 160w, <?php echo e($productImage); ?>?w=320 320w" sizes="(max-width: 640px) 160px, 320px">
                                        <?php else: ?>
                                    ...
                                    <div class="flex-1 p-3 min-w-0 flex flex-col gap-1">
                                        <div class="flex items-start justify-between gap-2">
                                            <h3 class="font-semibold text-sm leading-tight" :class="darkMode ? 'text-white' : 'text-gray-900'"><?php echo e($product->name); ?></h3>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->tags): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->description): ?>
                                            <p class="text-xs line-clamp-2" :class="darkMode ? 'text-gray-400' : 'text-gray-500'"><?php echo e($product->description); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->calories || $product->allergens): ?>
                                            <div class="flex items-center gap-2 flex-wrap">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->calories): ?>
                                                    <span class="text-[10px] font-medium" :class="darkMode ? 'text-gray-400' : 'text-gray-400'"><?php echo e($product->calories); ?> kcal</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->allergens): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = (array) $product->allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                        <span class="text-[10px] px-1.5 py-0.5 rounded bg-yellow-50 text-yellow-600 border border-yellow-100"><?php echo e($allergen); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasPriceRange): ?>
                                            <div class="flex flex-wrap gap-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeVariants->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <span class="text-[10px] px-1.5 py-0.5 rounded font-medium" :class="darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-600'"><?php echo e($variant->name); ?></span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeVariants->count() > 3): ?>
                                                    <span class="text-[10px] px-1.5 py-0.5 rounded font-medium" :class="darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-600'">+<?php echo e($activeVariants->count() - 3); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="mt-auto pt-1.5 flex items-center justify-between">
                                            <div class="font-bold text-sm" :style="{ color: primaryColor }">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasPriceRange): ?>
                                                    $<?php echo e(number_format($minPrice, 2)); ?> &ndash; $<?php echo e(number_format($maxPrice, 2)); ?>
                        ...
                        <div x-show="search !== '' && !categoryHasProducts('<?php echo e($category->slug); ?>')"
                            x-cloak
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('menuApp', () => ({
                ...
                lang: 'en',
                translations: {
                    en: <?php echo \Illuminate\Support\Js::from($enTranslations)->toHtml() ?>,
                    km: <?php echo \Illuminate\Support\Js::from($kmTranslations)->toHtml() ?>,
                },
                t(key) { return this.translations[this.lang][key] ?? key; },
                activeCategory: 'all',
                primaryColor: <?php echo \Illuminate\Support\Js::from($menuSettings['primary_color'] ?? '#f59e0b')->toHtml() ?>,
                title: <?php echo \Illuminate\Support\Js::from($menuSettings['title'] ?? config('app.name', 'POS Cafe'))->toHtml() ?>,
                subtitle: <?php echo \Illuminate\Support\Js::from($menuSettings['subtitle'] ?? '')->toHtml() ?>,
                logo: <?php echo \Illuminate\Support\Js::from($menuSettings['logo'] ? asset('storage/'.$menuSettings['logo']) : null)->toHtml() ?>,
                openingHours: <?php echo \Illuminate\Support\Js::from($menuSettings['opening_hours'] ?? '')->toHtml() ?>,
                isOpen: <?php echo \Illuminate\Support\Js::from($menuSettings['is_open'])->toHtml() ?>,
                hasPromo: <?php echo \Illuminate\Support\Js::from((bool) ($menuSettings['promo_banner'] ?? ''))->toHtml() ?>,
                promoBanner: <?php echo \Illuminate\Support\Js::from($menuSettings['promo_banner'] ?? '')->toHtml() ?>,
                promoBannerText: <?php echo \Illuminate\Support\Js::from($menuSettings['promo_banner_text'] ?? 'Special Offer!')->toHtml() ?>,
                enableKhmer: <?php echo \Illuminate\Support\Js::from((bool) ($menuSettings['enable_khmer'] ?? false))->toHtml() ?>,
                tableId: <?php echo \Illuminate\Support\Js::from($tableId)->toHtml() ?>,
                supportsShare: typeof navigator.share === 'function',
                socialLinks: <?php echo \Illuminate\Support\Js::from($menuSettings['social_links'] ?? [])->toHtml() ?>,
                socialIcons: {
...
<?php /**PATH D:\Herd\cafe-pos-shop\resources\views\menu\index.blade.php ENDPATH**/ ?>