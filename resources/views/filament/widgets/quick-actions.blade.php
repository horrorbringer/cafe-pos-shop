<x-filament-widgets::widget>
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <a href="{{ route('pos') }}"
            ...
            <div class="min-w-0">
                <p class="text-sm font-semibold text-gray-900 dark:text-white">New Order</p>
                <p class="text-xs text-gray-400 truncate">Open POS terminal</p>
            </div>
        </a>
        ...
        <a href="{{ \App\Filament\Resources\Orders\OrderResource::getUrl('index') }}"
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs text-gray-400 truncate">View all orders</p>
            </div>
        </a>
        ...
        <a href="{{ \App\Filament\Resources\Products\ProductResource::getUrl('index') }}"
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs text-gray-400 truncate">Manage catalog</p>
            </div>
        </a>
        ...
        <a href="{{ \App\Filament\Pages\ReportsPage::getUrl() }}"
            ...
            <div class="min-w-0">
                <p class="text-sm font-semibold text-gray-900 dark:text-white">Reports</p>
                <p class="text-xs text-gray-400 truncate">Sales analytics</p>
            </div>
        </a>
    </div>
</x-filament-widgets::widget>
